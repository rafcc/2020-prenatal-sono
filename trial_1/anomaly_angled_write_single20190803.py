...
image_dir = "/share/fujitsu/benchmark/dataset/split_n1333/n"
outfilename = "/home/fsakai/darknet-master/20190804_roc/map/normal/n3.csv"
...
if __name__ == "__main__":
    ...
    for i in range(1000):
        ...
        scores = []
        dobjs = []
        image = image_dir +str(int(l)) +"/" + str(int(i + 1)).zfill(3) + ".jpg"
